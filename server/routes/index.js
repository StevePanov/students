...
module.exports = function(app, db) {
  ...
  app.post('/students', (req, res) => {
    const student = { name: req.body.name, surname: req.body.surname, rating: req.body.rating};
  ...
  //   const id = req.params.id;
  //   const query = { '_id': new ObjectID(id) };
  //   const updStudent = { name: req.body.name, surname: req.body.surname, rating: req.body.rating};
